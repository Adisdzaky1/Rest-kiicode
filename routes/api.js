...
const tik = require("douyin-video-get");
...
const limit = await isLimit(apikey)
  ...
  const text = req.query.text
  if (!text) return res.json(msg.paramtext)
  await getBuffer(`https://api.yanzbotz.my.id/api/text2img/text2img?prompt=${text}`).then(buffer => {
    res.set({ 'Content-Type': 'image/png' })
    res.send(buffer)
  })
  limitMin(apikey);
...
router.get("/ai/midjourney", async (req, res, next) => {
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  const check = await checkKey(apikey)
  if (!check) return res.render('not-apikey', { layout: 'not-apikey' })
const limit = await isLimit(apikey)
  ...
  const text = req.query.text
  if (!text) return res.json(msg.paramtext)
  await getBuffer(`https://api.yanzbotz.my.id/api/text2img/midjourney?prompt=${text}`).then(buffer => {
    res.set({ 'Content-Type': 'image/png' })
    res.send(buffer)
  })
  limitMin(apikey);
...
router.get("/ai/realistic", async (req, res, next) => {
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  const check = await checkKey(apikey)
  if (!check) return res.render('not-apikey', { layout: 'not-apikey' })
const limit = await isLimit(apikey)
  ...
  const text = req.query.text
  if (!text) return res.json(msg.paramtext)
  await getBuffer(`https://api.yanzbotz.my.id/api/text2img/realistic?prompt=${text}`).then(buffer => {
    res.set({ 'Content-Type': 'image/png' })
    res.send(buffer)
  })
  limitMin(apikey);
})
router.get("/ai/neima", async (req, res, next) => {
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  const check = await checkKey(apikey)
  if (!check) return res.render('not-apikey', { layout: 'not-apikey' })
const limit = await isLimit(apikey)
  ...
  const text = req.query.text
  if (!text) return res.json(msg.paramtext)
  await getBuffer(`https://api.yanzbotz.my.id/api/text2img/neima?prompt=${text}`).then(buffer => {
    res.set({ 'Content-Type': 'image/png' })
    res.send(buffer)
  })
  limitMin(apikey);
})
router.get("/ai/absolutely", async (req, res, next) => {
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  const check = await checkKey(apikey)
  if (!check) return res.render('not-apikey', { layout: 'not-apikey' })
const limit = await isLimit(apikey)
  ...
  const text = req.query.text
  if (!text) return res.json(msg.paramtext)
  await getBuffer(`https://api.yanzbotz.my.id/api/text2img/absolutely?prompt=${text}`).then(buffer => {
    res.set({ 'Content-Type': 'image/png' })
    res.send(buffer)
  })
  limitMin(apikey);
})
router.get("/ai/absolutelyV2", async (req, res, next) => {
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  const check = await checkKey(apikey)
  if (!check) return res.render('not-apikey', { layout: 'not-apikey' })
const limit = await isLimit(apikey)
  ...
  const text = req.query.text
  if (!text) return res.json(msg.paramtext)
  await getBuffer(`https://api.yanzbotz.my.id/api/text2img/absolutelyV2?prompt=${text}`).then(buffer => {
    res.set({ 'Content-Type': 'image/png' })
    res.send(buffer)
  })
  limitMin(apikey);
})
router.get("/ai/anything", async (req, res, next) => {
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  const check = await checkKey(apikey)
  if (!check) return res.render('not-apikey', { layout: 'not-apikey' })
const limit = await isLimit(apikey)
  ...
  const text = req.query.text
  if (!text) return res.json(msg.paramtext)
  await getBuffer(`https://api.yanzbotz.my.id/api/text2img/anything?prompt=${text}`).then(buffer => {
    res.set({ 'Content-Type': 'image/png' })
    res.send(buffer)
  })
  limitMin(apikey);
})
router.get("/ai/anythingV2", async (req, res, next) => {
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  const check = await checkKey(apikey)
  if (!check) return res.render('not-apikey', { layout: 'not-apikey' })
const limit = await isLimit(apikey)
  ...
  const text = req.query.text
  if (!text) return res.json(msg.paramtext)
  await getBuffer(`https://api.yanzbotz.my.id/api/text2img/anythingV2?prompt=${text}`).then(buffer => {
    res.set({ 'Content-Type': 'image/png' })
    res.send(buffer)
  })
  limitMin(apikey);
})
router.get("/ai/anythingV3", async (req, res, next) => {
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  const check = await checkKey(apikey)
  if (!check) return res.render('not-apikey', { layout: 'not-apikey' })
const limit = await isLimit(apikey)
  ...
  const text = req.query.text
  if (!text) return res.json(msg.paramtext)
  await getBuffer(`https://api.yanzbotz.my.id/api/text2img/anythingV3?prompt=${text}`).then(buffer => {
    res.set({ 'Content-Type': 'image/png' })
    res.send(buffer)
  })
  limitMin(apikey);
...
router.get('/others/hercai', async (req, res, next) => {
  const query = req.query.q
  if (!query) return res.json(msg.paramquery)
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  const limit = await isLimit(apikey)
  if (limit) return res.render('limit', { layout: 'limit' })
  ibeng = await fetchJson(`https://herc-ai.onrender.com/v2/hercai?question=${query}`)
    .then(data => {
      let result = data;
      if (!result) res.json(msg.nodata)
      res.json({
...
router.get('/ai/blackbox', async (req, res, next) => {
  const query = req.query.q
  if (!query) return res.json(msg.paramquery)
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
...
router.get('/downloader/animevideo', async (req, res, next) => {
...
router.get('/downloader/animevideo2', async (req, res, next) => {
...
router.get('/ai/chatgptvoice', async (req, res, next) => {
  const query = req.query.q
  if (!query) return res.json(msg.paramquery)
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  ...
  const limit = await isLimit(apikey)
  if (limit) return res.render('limit', { layout: 'limit' })
  result = await fetch(`https://api.yanzbotz.my.id/api/ai/gptvoice?query=${query}`).then(v => v.buffer())
  await fs.writeFileSync(__path + '/tmp/voice.mp3', result)
  res.sendFile(__path + '/tmp/voice.mp3')
  limitMin(apikey);
})
...
router.get('/ai/bard2', async (req, res, next) => {
  ...
  fetch(encodeURI(`https://knlkuda.rizkyibeng211.repl.co/bard?ask=${query}`))
      .then(response => response.json())
    .then(data => {
      let result = data;
      if (!result) res.json(msg.error)
      res.json({
        status: "Success",
        code: 200,
        author: author,
...
router.get('/downloader/douyin', async (req, res, next) => {
  let url = req.query.url
  if (!url) return res.json(msg.paramurl)
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  ...
  fetch(encodeURI(`https://api.yanzbotz.my.id/api/downloader/douyin?url=${url}`))
      .then(response => response.json())
    .then(data => {
      let result = data.result
      if (!result) res.json(msg.error)
...
router.get('/downloader/spotify', async (req, res, next) => {
  ...
  fetch(encodeURI(`https://api.yanzbotz.my.id/api/downloader/spotify?url=${url}`))
      .then(response => response.json())
    .then(data => {
      let result = data.result
      if (!result) res.json(msg.error)
...
router.get('/downloader/snackvideo', async (req, res, next) => {
  let url = req.query.url
  if (!url) return res.json(msg.paramurl)
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  ...
  fetch(encodeURI(`https://api.yanzbotz.my.id/api/downloader/snackvideo?url=${url}`))
      .then(response => response.json())
    .then(data => {
      let result = data.result
      if (!result) res.json(msg.error)
...
router.get('/downloader/sfile', async (req, res, next) => {
  let url = req.query.url
  if (!url) return res.json(msg.paramurl)
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  ...
  fetch(encodeURI(`https://api.yanzbotz.my.id/api/downloader/sfile?url=${url}`))
      .then(response => response.json())
    .then(data => {
      let result = data.result
      if (!result) res.json(msg.error)
...
router.get('/downloader/twitch', async (req, res, next) => {
  let url = req.query.url
  if (!url) return res.json(msg.paramurl)
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  ...
  fetch(encodeURI(`https://api.yanzbotz.my.id/api/downloader/twitch?url=${url}`))
      .then(response => response.json())
    .then(data => {
      let result = data.result
      if (!result) res.json(msg.error)
...
router.get('/downloader/krakenfiles', async (req, res, next) => {
  let url = req.query.url
  if (!url) return res.json(msg.paramurl)
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  ...
  fetch(encodeURI(`https://api.yanzbotz.my.id/api/downloader/krakenfiles?url=${url}`))
      .then(response => response.json())
    .then(data => {
      let result = data.result
      if (!result) res.json(msg.error)
...
router.get('/downloader/snapchat', async (req, res, next) => {
  let url = req.query.url
  if (!url) return res.json(msg.paramurl)
  const apikey = req.query.apikey
  if (!apikey) return res.json(msg.paramkey)
  ...
  fetch(encodeURI(`https://api.yanzbotz.my.id/api/downloader/snapchat?url=${url}`))
      .then(response => response.json())
    .then(data => {
      let result = data.result
      if (!result) res.json(msg.error)
