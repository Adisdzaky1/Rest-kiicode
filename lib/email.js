    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs iBeng</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6281257172080">WhatsApp</a></span></span>
            <span style="display: block;"><br>By,<br>iBeng</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"iBeng" <admin@ibeng.tech>',
        to: email,
        subject: 'Verify Email - Api iBeng',
        html: inboxGmail,
      };
